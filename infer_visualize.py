...
def main(argv):
    ...
    output_dir = os.path.join(resultsroot, experiment_name, strategy, 'output')
    ...
    pretrained_weights = glob.glob(os.path.join(weights_dir, "best_model*.pth"))[0]
    cfg.MODEL.WEIGHTS = pretrained_weights  # path to the model we just trained
